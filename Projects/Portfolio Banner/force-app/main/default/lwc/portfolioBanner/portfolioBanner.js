...
export default class PortfolioBanner extends LightningElement {
    @api recordId //= 'a002w00000XLQHsAAP'
    @api linkedinUrl //= 'https://www.linkedin.com/in/naguru-karimulla-819971171/'
    @api twitterUrl //= 'https://twitter.com/'
    @api githubUrl //= 'https://github.com/nagurukarimulla'
    @api youtubeUrl //= 'https://youtube.com/'
    @api trailheadUrl //= 'https://trailblazer.me/id/nkarim29'
    @api blogUrl //= 'https://'


    userPic = `${PortfolioAssets}/PortfolioAssets/07.jpg`
